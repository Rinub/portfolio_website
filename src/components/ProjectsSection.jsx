...
import { ExternalLink, Github, Sparkles, Bot, Layers, CheckCircle2, ArrowRight, ShieldCheck, Database, Terminal } from 'lucide-react';
...
export default function ProjectsSection() {
  ...
  return (
    <section id="projects" className="section bg-[#07090e] relative border-t border-white/10">
      <div className="container relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 pb-6 border-b border-white/10">
          <div>
            ...
            <p className="text-sm text-[#94A3B8] max-w-xl">
              Production-grade applications, AI agents, and enterprise data platforms built by Ibrahim Rinub Babu.
            </p>
          </div>
        ...
        <div className="space-y-8 max-w-5xl mx-auto">
          {filteredProjects.map((project) => (
            <div 
              key={project.id}
              className="glass-card p-8 transition-all hover:border-[#00F5A0]/50"
            >
              {/* Header Row */}
              ...
              <div className="p-4 rounded-xl bg-black/40 border border-white/5 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  {project.architectureHighlights.map((item, hIdx) => (
                    <div key={hIdx} className="flex items-start gap-2 text-xs text-white/90 font-mono">
