...
import { Mail, Phone, MapPin, Linkedin, Github, Copy, Check, Send, Sparkles, Download, Heart } from 'lucide-react';
      ...
      <div className="container relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="section-subtitle mx-auto">
            ...
            or high-scale AI engineering collaborations.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-6xl mx-auto mb-16">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between p-8 rounded-2xl bg-white/[0.02] border border-white/10 backdrop-blur-xl">
            <div>
              <h3 className="font-heading font-extrabold text-2xl text-white mb-2">
                Ibrahim Rinub Babu
              </h3>
              <p className="text-sm text-[#00F5A0] font-mono mb-6">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="p-4 rounded-xl bg-black/40 border border-white/10 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-[#00F5A0]/10 border border-[#00F5A0]/30 flex items-center justify-center">
                      <Mail className="w-5 h-5 text-[#00F5A0]" />
                    </div>
                    <div>
                      <div className="text-[10px] font-mono text-white/50">EMAIL ADDRESS</div>
                  ...
                  >
                    {copied ? <Check className="w-4 h-4 text-[#00F5A0]" /> : <Copy className="w-4 h-4 text-[#94A3B8]" />}
                  </button>
                </div>
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-[#00D2FF]/10 border border-[#00D2FF]/30 flex items-center justify-center">
                    <Phone className="w-5 h-5 text-[#00D2FF]" />
                  </div>
                  <div>
                    <div className="text-[10px] font-mono text-white/50">PHONE / WHATSAPP</div>
                ...
                <div className="p-4 rounded-xl bg-black/40 border border-white/10 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-[#F59E0B]/10 border border-[#F59E0B]/30 flex items-center justify-center">
                    <MapPin className="w-5 h-5 text-[#F59E0B]" />
                  </div>
                  <div>
                    <div className="text-[10px] font-mono text-white/50">LOCATION</div>
            ...
            {/* Social Buttons */}
            <div>
              <div className="text-xs font-mono text-white/50 mb-3">SOCIAL PROFILES</div>
              <div className="flex items-center gap-3">
                <a
          ...
          {/* Contact Form */}
          <div className="lg:col-span-7 p-8 rounded-2xl bg-white/[0.02] border border-white/10 backdrop-blur-xl">
            ...
            {formSubmitted ? (
              <div className="p-8 rounded-xl bg-[#00F5A0]/10 border border-[#00F5A0]/30 text-center py-12">
                ...
                <p className="text-xs text-[#94A3B8]">Thank you for reaching out. Ibrahim will respond to your inquiry shortly.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-xs font-mono text-white/70 mb-1">Your Email</label>
                    <input
                      type="email"
                      required
                ...
                <div>
                  <label className="block text-xs font-mono text-white/70 mb-1">Subject</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-xs font-mono text-white/70 mb-1">Message</label>
                  <textarea
                    rows="4"
                    required
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-white/50">
          ...
          <div className="flex items-center gap-4">
            <a href="/resume_faangpath.tex" download="Ibrahim_Rinub_Babu_Resume.tex" className="hover:text-[#00F5A0] transition-colors">
              Download CV TeX
            </a>
            <span>•</span>
